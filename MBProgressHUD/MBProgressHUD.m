...
+ (MB_INSTANCETYPE)showHUDAddedTo:(UIView *)view bgColor:(UIColor *)bgColor tintColor:(UIColor *)tintColor labelText:(NSString *)title animated:(BOOL)animated {
    MBProgressHUD *hud = [[self alloc] initWithView:view];
    hud.removeFromSuperViewOnHide = YES;
    hud.color = bgColor;
    hud.labelColor = tintColor;
    hud.activityIndicatorColor = tintColor;
    hud.labelText = title;
    [view addSubview:hud];
    [hud show:animated];
    return MB_AUTORELEASE(hud);
